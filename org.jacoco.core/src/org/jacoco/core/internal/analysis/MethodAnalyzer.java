...
public class MethodAnalyzer extends MethodProbesVisitor {
	...
	private final MethodCoverageCalculator accounting;
	...
	MethodAnalyzer(final String name, final String desc, final String signature,
		...
		this.accounting = new MethodCoverageCalculator(name, desc, signature);
	}
	...
	public void accept(final MethodNode methodNode,
		...
		filter.filter(methodNode, filterContext, accounting);
	...
	public void visitEnd() {
		...
		accounting.calculateCoverage(instructions, firstLine, lastLine);
